package com.ruyuan2020.im.c2c.handler;
...
public class MessageHandler {
    ...
    @KafkaListener(topics = "#{'topic-c2c-message-send-'.concat('${spring.profiles.active}')}", properties = {
    ...
    @KafkaListener(topics = "#{'topic-c2c-message-ack-'.concat('${spring.profiles.active}')}")
